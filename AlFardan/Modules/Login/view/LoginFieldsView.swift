...
class LoginFieldsView: UIView {
    ...
    weak var delegate: LoginFieldsProtocol?
...
//        registerButton.backgroundColor = .white
        registerButton.addTarget(self, action: #selector(self.didTapRegisterButton(_:)), for: .touchUpInside)
        self.addSubview(registerButton)
        
        NSLayoutConstraint.activate([
            NSLayoutConstraint(item: registerButton, attribute: .top, relatedBy: .equal, toItem: loginButton, attribute: .bottom, multiplier: 1, constant: 15),
            NSLayoutConstraint(item: registerButton, attribute: .leading, relatedBy: .equal, toItem: self, attribute: .leading, multiplier: 1, constant: 15),
            NSLayoutConstraint(item: registerButton, attribute: .trailing, relatedBy: .equal, toItem: self, attribute: .trailing, multiplier: 1, constant: -15),
            NSLayoutConstraint(item: registerButton, attribute: .height, relatedBy: .equal, toItem: nil, attribute: .notAnAttribute, multiplier: 1, constant: 50),
            NSLayoutConstraint(item: registerButton, attribute: .bottom, relatedBy: .equal, toItem: self, attribute: .bottom, multiplier: 1, constant: -30),
        ])
    }
